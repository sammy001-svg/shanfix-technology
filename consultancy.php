<?php include 'includes/header.php'; ?>    <section class="service-hero hero-consultancy">
        ...
        <div class="container service-hero-content">
            ...
            <p class="hero-subtitle" data-aos="fade-up" data-aos-delay="100">Expert technology advice to guide your strategic business decisions.</p>
        </div>
    </section>
        ...
        <div class="container">
            <div class="service-main">
                ...
                <p class="lead section-lead">
                    At Shanfix Technology, we specialize in <strong>Consultancy</strong>. 
                    Expert technology advice to guide your strategic business decisions. Our commitment to excellence ensures that we provide solutions that drive success.
                </p>
                ...
                <p>
                    Discover more about how we can help you achieve your goals with our professional <strong>Consultancy</strong>.
                </p>
            </div>
        </div>
